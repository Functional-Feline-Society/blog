...
The http4s DSL expects an `EntityEncoder` to be available for whatever entity you provide to apply - in our case it’s expecting a `EntityEncoder[IO, List[FullName]]`. 
