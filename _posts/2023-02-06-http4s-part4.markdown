...
In this blog post, we’d like to go through how Santa’s workshop makes use of [http4s](https://http4s.org). We'll go over how to setup a server and a client, some interesting things about the internals of `httpApp`, how we encode and decode, and as usual some excellent pictures of cats.
